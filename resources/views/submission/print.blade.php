...
<head>
  ...
  <div class="col-lg-6">
      ...
      <tbody>
    	...
    	<tr>
          <td align="center" rowspan="3">
            <b>FORMULIR PENGAJUAN PERMOHONAN<br>PRAKTIK INDUSTRI</b></td>
    ...
    <div class="col-lg-6">
      ...
      <p class="small">Bersama surat ini kami mohon untuk diterbitkan Surat Permohonan Praktik Kerja Industri pada:</p>
      <table class="borderless">
        <tr class="borderless">
            <td class="borderless">Nama Perusahaan</td>
            <td class="borderless"> :</td>
            <td class="borderless"> {{$data[0]->industry_name}}</td>
        </tr>
        <tr class="borderless">
            <td class="borderless">&nbsp;</td>
        </tr>
        <tr class="borderless">
            ...
            <td class="borderless"> :</td>
            <td class="borderless"> {{$data[0]->address}}</td>
        </tr>
        <tr class="borderless">
            <td class="borderless">&nbsp;</td>
        </tr>
