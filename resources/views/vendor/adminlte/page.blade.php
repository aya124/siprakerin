        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb float-sm-right text-uppercase">
                    @if (array_search('home', explode('/', request()->path())) === FALSE)
                        <li class="breadcrumb-item"><a href="{{ url('home') }}">home
                        ({{ auth()->user()->name }})</a></li>
                    @endif
                    ...
                    @continue
                    @endif
                    @if (basename(request()->path()) != $item )
                    <li class="breadcrumb-item"><a href="{{ url($item) }}">{{ $item }}</a></li> 
                    @else
                    @if ($item == 'home')
                    <li class="breadcrumb-item active">home ({{ auth()->user()->name }})</li>
                    @else
