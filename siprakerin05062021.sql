...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2021 at 11:02 AM
...
(1, 1, 'Antariksa Net', 'Ngalian', 'Sleman', '62888945435', 'https://antariksa.net/', '2020-01-05 02:29:33', '2021-06-03 05:32:13', 'disetujui', '1'),
...
(3, 1, 'PT. Jogja Media Net', 'Jl. Bhineka Tunggal Ika K – 2 Sekip Bulaksumur', 'Yogyakarta', '0274544000', 'http://web.jogjamedianet.com/', '2020-01-05 02:55:41', '2021-06-05 02:13:20', 'belum disetujui', NULL),
...
(5, 1, 'Universitas Janabadra', 'Jl. Tentara Rakyat Mataram No.58 Bumijo, Jetis', 'Yogyakarta', '0274561039', 'https://janabadra.ac.id/', '2020-01-05 02:57:17', '2021-06-03 15:30:52', 'disetujui', NULL),
...
(16, 1, 'PT. SIMS Jogja Media Net', 'Jl. Kenari', 'Yogyakarta', '085123725423', NULL, '2021-03-09 20:45:56', '2021-06-05 02:13:37', 'belum disetujui', NULL),
(18, 1, 'Fakultas Filsafat UGM', 'Jl. Olahraga Caturtunggal Depok', 'Sleman', '085123725444', 'https://ff.ugm.ac.id/', '2021-05-28 07:14:35', '2021-06-03 15:34:19', 'disetujui', NULL);
...
CREATE TABLE `scores` (
  ...
  `score_a` enum('baik','amat baik','cukup','') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'baik',
  `score_b` enum('baik','amat baik','cukup','') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'baik',
  `score_c` enum('baik','amat baik','cukup','') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'baik',
  `score_d` enum('baik','amat baik','cukup','') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'baik',
  `score_e` enum('baik','amat baik','cukup','') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'baik',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 74, NULL, 'Aya Shofia', NULL, '2021-06-03 15:01:48', '2021-06-03 15:01:48');
...
(5, 1, '2021-06-01', '2021-08-31', 'raraa', 14, NULL, 6, '2021-05-28 08:50:25', '2021-06-05 02:49:05', NULL, NULL, NULL, 8, 1, '1'),
(6, NULL, '2021-05-01', '2021-07-31', 'shawnferry', 2, NULL, 8, '2021-05-28 09:21:12', '2021-05-28 11:10:10', NULL, NULL, NULL, 8, 1, NULL),
(8, NULL, '2021-09-01', '2022-02-28', 'raraa', 2, NULL, 1, '2021-06-05 02:26:27', '2021-06-05 02:26:27', NULL, NULL, NULL, 8, 2, NULL);
...
(1, 5, 'surat-pengantar-wks-sample.jpg', 'suratpengantar', 'E:\\web\\xampp\\htdocs\\siprakerin\\public/files/suratpengantar/', '2021-06-05 02:49:05', '2021-06-05 02:49:05');
...
(1, 'admin', 'admin', 'male', 'admin@local.host', '2019-10-10 08:15:57', NULL, '$2y$10$PqT/ucrW5n13KNpRXkmvJO0P.04HAhfPttpEbUomCSGnsyEzTDccK', 'j7ZRS6kDewrC9NWKAlf1pn4dqfIts19ZzHyrjhnHOlkVR8qfwg6kGLxS6fbH', '2019-10-10 08:15:58', '2020-02-19 02:38:55'),
(6, 'shawnferry', 'Shawn Ferry V', 'male', 'shawnferryv@gmail.com', '2019-10-10 08:16:00', 1, '$2y$10$yi531uMJOZyt6XJ3RiHUn.S2ErhRLMK9TBsr45q7XU9Y1N0kgaD72', 'pgsBEOCSxHQaw4x8D3OyToUskieiY74qKyml33u2Arh6qOrKy1mgSc5RnNqR', '2019-10-10 08:16:03', '2021-05-28 09:21:12'),
...
(71, 'raraa', 'Rara Amilia', 'female', 'aya12496@gmail.com', NULL, NULL, '$2y$10$RFcsF4dUaGdiedkOSPsV8eRadszlDD06V.qKAEa88CYbB7fhIpje2', NULL, '2021-05-28 05:37:08', '2021-06-05 02:26:27'),
(74, 'ayashofia', 'Aya Shofia', 'female', 'ayashofia@gmail.com', NULL, NULL, '$2y$10$ktB.TKw6TfhZVbK8apxw5em6Y7DrN.n6cGoEpoiFad6f/4rnkheOe', NULL, '2021-06-03 15:01:48', '2021-06-03 15:01:48');
