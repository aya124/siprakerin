...
class ValidationController extends Controller
{
    ...
    public function index()
    {
        ...
        if(request()->ajax())
        {
            ...
            ->select('sub.id',
                DB::raw('u.name as username'),'i.name','sub.start_date','sub.finish_date')
    ...
    public function tabsetuju()
    {
        ...
        if(request()->ajax())
        {
            ...
            ->select('sub.id',
                DB::raw('u.name as user_name'),'i.name','sub.start_date','sub.finish_date',
    ...
    public function pengantar_pdf($id)
    {
        ...
        $data = DB::table('submissions as sub')
            ...
            // ->join('statuses as st', 'st.id', '=', 'sub.status_id')
            ->select('u.name','i.address','i.city','s.class','sub.start_date','sub.finish_date', 
